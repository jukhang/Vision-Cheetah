...
//  this->_stateEstimatorData.result->position[0] = this->_stateEstimatorData.cheaterState->position.template cast<T>()[0];
//  this->_stateEstimatorData.result->position[2] = this->_stateEstimatorData.cheaterState->position.template cast<T>()[2];
